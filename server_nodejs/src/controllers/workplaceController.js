...
exports.addWorkplace = async (req, res) => {
    try {
        const { name, abbreviation, address } = req.body; // Get workplace details from request body
        ...
        const result = await db.query(
            `INSERT INTO organizations (name, abbreviation, address) 
        ...
        await db.query(
            ...
            VALUES ($1, $2, 1, 15.00, 'Manager')`, // Assign the user as Manager with a default pay rate
